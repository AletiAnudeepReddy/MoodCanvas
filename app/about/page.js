  ...
  return (
    <div className="max-w-7xl mx-auto px-6 py-7">
      ...
      <section className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 mb-15">
        <FeatureCard icon={<SparklesIcon className="h-8 w-8 text-purple-500" />} title="AI-Powered Imagery" text="Wallpapers generated using DALL·E or Stability AI." />
      ...
      <section className="text-center mb-10">
        <h3 className="text-2xl font-semibold mb-4">Ready to turn feelings into art?</h3>
        <div className="flex justify-center gap-4">
          <Link href="/shorten">
            <button className="bg-purple-600 text-white px-6 py-2 rounded-full hover:bg-purple-700 flex items-center gap-2">
              <SparklesIcon className="w-5 h-5" />
              Try MoodCanvas
            </button>
          </Link>
          <Link href="https://github.com/AletiAnudeepReddy" target="_blank">
            <button className="border border-purple-500 text-purple-600 px-6 py-2 rounded-full bg-white flex items-center gap-2 hover:bg-purple-100">
